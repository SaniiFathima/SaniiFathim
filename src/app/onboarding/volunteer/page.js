...
export default function Page() {
  ...
  useEffect(() => {
    ...
    }, 1000); // Image will fade out after 1.7 seconds
  ...
  return (
    <>
      <div className={`relative overflow-hidden min-h-screen flex flex-col items-center justify-center ${styles.animatedBackground}`}>
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-10" style={{ backgroundImage: 'url(/register.png)' }}></div>
        ...
        <div className="relative z-10 text-center mt-10 mb-20 px-4">
          <div className="text-5xl leading-tight tracking-tight font-extrabold text-white bg-opacity-50 rounded-xl p-4 animate-fadeInDown">
            Oh oh! Looks like you need to <span className="text-yellow-300">register</span> first.
          </div>
